...
* `localinfo seperatebackpackmodels 1` server setting to have different visual models for bags dropped on death ``progs/deathbag.mdl`` and discards ``progs/discard.mdl`` 
