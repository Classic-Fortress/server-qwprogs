...
* Option for medic secondary grenade changed to "Blast grenade" (blast like cuss grenade but no cuss effect, 12.5% weaker, no medic speedhump) (0 original, 1 blast). `localinfo mediccussgren_type 1`.
