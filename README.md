...
New features
------
* ``setinfo keepcells <number>`` allows scout/med/pyro/eng/hwguy to discard cells, x is how many they wish to keep. eg. an eng with 200 cells that has ``setinfo keepcells 50`` will discard 150 cells and keep 50 (suggest users put in class configs)
